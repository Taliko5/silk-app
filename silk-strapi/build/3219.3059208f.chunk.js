...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [3219],
  {
    ...
    /***/ 53219: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      __webpack_require__.d(__webpack_exports__, {
        Z: () => /* binding */ EditView,
      });
      ...
      // EXTERNAL MODULE: ./node_modules/yup/es/index.js + 26 modules
      var yup_es = __webpack_require__(87561); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/EditView/utils/schema.js
      const schema = yup_es /* object */
        ...
        .shape({
          ...
          description: yup_es /* string */
            .Z_()
            .nullable(),
          lifespan: yup_es /* number */
            .Rx()
            .integer()
            .min(0)
            .nullable()
            .defined(helper_plugin_esm /* translatedErrors.required */.I0.required),
          permissions: yup_es /* string */
            .Z_(helper_plugin_esm /* translatedErrors.string */.I0.string)
            .required(helper_plugin_esm /* translatedErrors.required */.I0.required),
        });
      /* harmony default export */ const utils_schema = schema; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/EditView/utils/index.js
      ...
      // EXTERNAL MODULE: ./node_modules/prop-types/index.js
      var prop_types = __webpack_require__(45697);
      var prop_types_default = /*#__PURE__*/ __webpack_require__.n(prop_types); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/EditView/components/LoadingView/index.js
      ...
      var TokenTypeSelect = __webpack_require__(31065); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/EditView/components/FormTransferTokenContainer/index.js
      ...
      var constants = __webpack_require__(47670); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/EditView/index.js
      ...
      const TransferTokenCreateView = () => {
        ...
        const {
          ...
          permissions /* default.settings.transfer-tokens */.Z.settings['transfer-tokens']
        );
        const {
          params: { id },
        ...
        if (isLoading) {
          return /* @__PURE__ */ (0, jsx_runtime.jsx)(components_LoadingView, {
            transferTokenName: transferToken?.name,
          });
        }
                    ...
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(ContentLayout /* ContentLayout */.D, {
                      children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, jsx_runtime.jsx)(components_FormTransferTokenContainer, {
                            errors,
