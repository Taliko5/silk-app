(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [2282],
  {
    /***/ 8971: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      'use strict';
      // ESM COMPAT FLAG
      ...
      var utils = __webpack_require__(89031); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/Providers/utils/forms.js
      const callbackLabel = {
      ...
      const keyLabel = {
        id: (0, utils /* getTrad */.OB)('PopUpForm.Providers.key.label'),
              ...
              key: yup_es /* string */
                ...
                .when('enabled', {
                  ...
                  then: yup_es /* string */
                    .Z_()
                    .required(helper_plugin_esm /* translatedErrors.required */.I0.required),
                  otherwise: yup_es /* string */
                    .Z_(),
                }),
              secret: yup_es /* string */
                .Z_()
                .when('enabled', {
                  is: true,
                  then: yup_es /* string */
      ...
      /* harmony default export */ const utils_forms = forms_forms; // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/Providers/utils/api.js
      ...
      var sortBy_default = /*#__PURE__*/ __webpack_require__.n(sortBy); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/Providers/utils/createProvidersArray.js
      ...
      var TextInput = __webpack_require__(16364); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/components/FormModal/Input/index.js
      const Input = ({
        description,
        disabled,
        intlLabel,
      ...
      /* harmony default export */ const FormModal_Input = Input; // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/components/FormModal/index.js
          ...
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsx)(ModalHeader /* ModalHeader */.x, {
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Breadcrumbs /* Breadcrumbs */.O, {
                ...
                children: headerBreadcrumbs.map((crumb) =>
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(Breadcrumbs /* Crumb */.$, { children: crumb }, crumb)
                ),
              }),
            }),
                            ...
                            return row.map((input) => {
                              return /* @__PURE__ */ (0, jsx_runtime.jsx)(
                                GridItem /* GridItem */.P,
                                {
                                  col: input.size,
                                  xs: 12,
                                  children: /* @__PURE__ */ (0, jsx_runtime.jsx)(FormModal_Input, {
                                    ...input,
      ...
      /* harmony default export */ const components_FormModal = FormModal; // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/Providers/index.js
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Th, {
                                  children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                                    ...
                                    textColor: 'neutral600',
                                    children: formatMessage({
                                      id: (0, utils /* getTrad */.OB)('Providers.status'),
      ...
      const ProtectedProvidersPage = () =>
        /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* CheckPagePermissions */.O4, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsx)(ProvidersPage, {}),
        });
