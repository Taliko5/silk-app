...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [7027],
  {
    /***/ 27887: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      ...
      var Box = __webpack_require__(41580); // CONCATENATED MODULE: ./.cache/admin/src/components/DragLayer/DragLayer.js
    ...
    /***/ 99781: /***/ (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
      /* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);

      const WysiwygContext = (0, react__WEBPACK_IMPORTED_MODULE_0__.createContext)();
      /* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ =
        /* unused pure expression or super */ null && WysiwygContext;

      /***/
    },

    /***/ 75642: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      __webpack_require__.d(__webpack_exports__, {
      ...
      var selectors = __webpack_require__(21323); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useContentTypeLayout/index.js
      ...
      var utils = __webpack_require__(47815); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useFetchContentTypeLayout/utils/formatLayouts.js
      ...
      const formatLayouts = (initialData, models) => {
        ...
        Object.keys(data.components).forEach((componentUid) => {
          const formattedComponentEditLayout = formatLayoutWithMetas(data.components[componentUid], models);
          ...
          const row = current.map((attribute) => {
            ...
            if (fieldSchema.type === 'relation') {
              ...
              set_default()(data, 'queryInfos', {
                shouldDisplayRelationLink: shouldDisplayRelationLink(contentTypeConfiguration, attribute.name, models),
              });
            }
            return data;
          });
      ...
      var immer_esm = __webpack_require__(18172); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useFetchContentTypeLayout/reducer.js
      const initialState = {
        error: null,
        isLoading: true,
        layout: {},
      ...
      var App_selectors = __webpack_require__(84668); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useFetchContentTypeLayout/index.js
      const useFetchContentTypeLayout = (contentTypeUID) => {
        const [{ error, isLoading, layout, layouts }, dispatch] = (0, react.useReducer)(
          useFetchContentTypeLayout_reducer,
          initialState
        );
      ...
      /* harmony default export */ const hooks_useFetchContentTypeLayout = useFetchContentTypeLayout; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useFindRedirectionLink/selectors.js
      ...
      var isObject_default = /*#__PURE__*/ __webpack_require__.n(isObject); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useFindRedirectionLink/utils/getRedirectionLink.js
      ...
      /* harmony default export */ const utils_getRedirectionLink = getRedirectionLink; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useFindRedirectionLink/index.js
      ...
      var react_router = __webpack_require__(16550); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/usePluginsQueryParams/index.js
      ...
      var constants = __webpack_require__(80015); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useSyncRbac/actions.js
      ...
      const resetPermissions = () => ({ type: constants /* RESET_PERMISSIONS */.Q }); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useSyncRbac/selectors.js

      const selectPermissions = (state) => state['content-manager_rbacManager'].permissions;
      const selectCollectionTypePermissions = (state) => state.rbacProvider.collectionTypesRelatedPermissions; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useSyncRbac/index.js
      ...
      var Wysiwyg = __webpack_require__(99781); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/useWysiwyg.js
      const useWysiwyg = () => useContext(WysiwygContext);
      /* harmony default export */ const hooks_useWysiwyg = /* unused pure expression or super */ null && useWysiwyg; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/usePrev.js
      ...
      var useKeyboardDragAndDrop = __webpack_require__(40703); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/hooks/index.js

      /***/
    },

    /***/ 15699: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var react_dnd__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
        react_dnd__WEBPACK_IMPORTED_MODULE_2__
      );
      ...
      const useDragAndDrop = (
        ...
        const handleKeyDown = (0, _useKeyboardDragAndDrop__WEBPACK_IMPORTED_MODULE_1__ /* .useKeyboardDragAndDrop */.A)(
          active,
          index,
          {
            onGrabItem,
    ...
    /***/ 40703: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 84668: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      const makeSelectModelLinks = () =>
        (0, reselect__WEBPACK_IMPORTED_MODULE_1__ /* .createSelector */.P1)(selectAppDomain(), (state) => ({
      ...
      const makeSelectModelAndComponentSchemas = () =>
        (0, reselect__WEBPACK_IMPORTED_MODULE_1__ /* .createSelector */.P1)(
          selectAppDomain(),
          ({ components, models }) => ({
            schemas: [...components, ...models],
          })
        );
      const selectFieldSizes = (0, reselect__WEBPACK_IMPORTED_MODULE_1__ /* .createSelector */.P1)(
        selectAppDomain(),
        (state) => state.fieldSizes
      );
      /* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ =
        /* unused pure expression or super */ null && makeSelectApp;
    ...
    /***/ 56723: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      });
    ...
    /***/ 69881: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      });
    ...
    /***/ 47815: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      // EXTERNAL MODULE: ./node_modules/lodash/cloneDeep.js
      var cloneDeep = __webpack_require__(50361);
      var cloneDeep_default = /*#__PURE__*/ __webpack_require__.n(cloneDeep); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/arrayMoveItem.js
      ...
      var toLower_default = /*#__PURE__*/ __webpack_require__.n(toLower); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/checkIfAttributeIsDisplayable.js
      ...
      /* harmony default export */ const utils_checkIfAttributeIsDisplayable = checkIfAttributeIsDisplayable; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/composeRefs.js
      ...
      // EXTERNAL MODULE: ./node_modules/lodash/get.js
      var get = __webpack_require__(27361);
      var get_default = /*#__PURE__*/ __webpack_require__.n(get); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/createDefaultForm.js
      ...
      var omit_default = /*#__PURE__*/ __webpack_require__.n(omit); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/formatLayoutToApi.js
      ...
      /* harmony default export */ const utils_formatLayoutToApi = formatLayoutToApi; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/generatePermissionsObject.js
      ...
      var isNaN_default = /*#__PURE__*/ __webpack_require__.n(lodash_isNaN); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/getFieldName.js
      const getFieldName = (stringName) =>
        stringName.split('.').filter((string) => isNaN_default()(parseInt(string, 10)));
      /* harmony default export */ const utils_getFieldName = getFieldName; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/getMaxTempKey.js
      ...
      /* harmony default export */ const utils_getMaxTempKey = getMaxTempKey; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/getRequestUrl.js
      ...
      // EXTERNAL MODULE: ./node_modules/lodash/set.js
      var set = __webpack_require__(36968);
      var set_default = /*#__PURE__*/ __webpack_require__.n(set); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/mergeMetasWithSchema.js
      ...
      // EXTERNAL MODULE: ./node_modules/@strapi/helper-plugin/build/helper-plugin.esm.js + 25 modules
      var helper_plugin_esm = __webpack_require__(548); // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/removePasswordFieldsFromData.js
      ...
      /* harmony default export */ const utils_removePasswordFieldsFromData = removePasswordFieldsFromData; // CONCATENATED MODULE: ./.cache/admin/src/content-manager/utils/index.js

      /***/
    },

    /***/ 75194: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      __webpack_require__.d(__webpack_exports__, {
      ...
      var colors = __webpack_require__(13037); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/Stages/Stage/components/OptionColor/OptionColor.js
      function OptionColor({ children, ...props }) {
        const { color } = props.data;
        const { themeColorName } = (0, colors /* getStageColorByHex */.k)(color);
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(index_a86253bb_esm.c.Option, {
          ...props,
    ...
    /***/ 54878: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      __webpack_require__.d(__webpack_exports__, {
      ...
      var Typography = __webpack_require__(75515);
      // EXTERNAL MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/utils/colors.js
      var colors = __webpack_require__(13037); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/Stages/Stage/components/SingleValueColor/SingleValueColor.js
      function SingleValueColor({ children, ...props }) {
        const { color } = props.data;
        const { themeColorName } = color ? (0, colors /* getStageColorByHex */.k)(color) : {};
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(index_a86253bb_esm.c.SingleValue, {
          ...props,
          children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
            alignItems: 'center',
            gap: 2,
    ...
    /***/ 53616: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      const STAGE_COLOR_DEFAULT =
        _strapi_design_system__WEBPACK_IMPORTED_MODULE_0__ /* .lightTheme.colors.primary600 */.W.colors.primary600;
    ...
    /***/ 53752: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 13037: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      function getStageColorByHex(hex) {
        ...
        const themeColors = Object.entries(
          _strapi_design_system__WEBPACK_IMPORTED_MODULE_1__ /* .lightTheme.colors */.W.colors
      ...
      function getAvailableStageColors() {
        return Object.entries(_constants__WEBPACK_IMPORTED_MODULE_0__ /* .STAGE_COLORS */.lv).map(
          ([themeColorName, name]) => ({
            hex: _strapi_design_system__WEBPACK_IMPORTED_MODULE_1__ /* .lightTheme.colors */.W.colors[themeColorName]
              .toUpperCase(),
            name,
          })
        );
