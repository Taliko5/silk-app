(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [5345],
  {
    /***/ 65936: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      'use strict';
      ...
      function errorToObject(error) {
        var _a;
        return (0, tslib__WEBPACK_IMPORTED_MODULE_0__ /* .__assign */.pi)(
          {
            name: error.name,
          ...
          switch (part[0]) {
            ...
            case '[': {
              ...
              if (attributeMatch) {
                addAttribute(
                  attributeMatch[1],
                  (_b = (_a = attributeMatch[4]) !== null && _a !== void 0 ? _a : attributeMatch[5]) !== null &&
                    _b !== void 0
                    ? _b
                    : ''
                );
      ...
      function isGecko() {
        ...
        return (
          countTruthy([
            ...
            'MozAppearance' in
              ((_b = (_a = document.documentElement) === null || _a === void 0 ? void 0 : _a.style) !== null &&
              _b !== void 0
                ? _b
                : {}),
      ...
      function getFullscreenElement() {
        var d = document;
        return (
          d.fullscreenElement || d.msFullscreenElement || d.mozFullScreenElement || d.webkitFullscreenElement || null
        );
      }
                ...
                return [
                  ...
                  new Promise(function (_resolve, _reject) {
                    ...
                    var checkReadyState = function () {
                      ...
                      if (
                        ((_b = (_a = iframe.contentWindow) === null || _a === void 0 ? void 0 : _a.document) === null ||
                        _b === void 0
                          ? void 0
      ...
      function getScreenFrame() {
        ...
        watchScreenFrame();
        return function () {
          return (0, tslib__WEBPACK_IMPORTED_MODULE_0__ /* .__awaiter */.mG)(_this, void 0, void 0, function () {
            var frameSize;
            return (0, tslib__WEBPACK_IMPORTED_MODULE_0__ /* .__generator */.Jh)(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  if (screenFrameBackup) {
                    return [
                      2 /*return*/,
                      (0, tslib__WEBPACK_IMPORTED_MODULE_0__ /* .__spreadArray */.ev)([], screenFrameBackup, true),
                    ];
                  }
      ...
      function withNaturalFonts(action, containerWidthPx) {
        ...
        return withIframe(function (_, iframeWindow) {
          ...
          linesOfText.textContent = (0, tslib__WEBPACK_IMPORTED_MODULE_0__ /* .__spreadArray */.ev)(
            [],
      ...
      function getVideoCard() {
        ...
        var canvas = document.createElement('canvas');
        var gl =
          (_a = canvas.getContext('webgl')) !== null && _a !== void 0 ? _a : canvas.getContext('experimental-webgl');
    ...
    /***/ 36808: /***/ (module, exports, __webpack_require__) => {
    ...
    /***/ 92052: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 66913: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 98601: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    /***/ 29558: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      'use strict';
      ...
      var lib = __webpack_require__(39943); // CONCATENATED MODULE: ./node_modules/@formatjs/intl/lib/src/message.js
      ...
      function deepMergeOptions(opts1, opts2) {
        ...
        return keys.reduce(function (all, k) {
          all[k] = (0, tslib_es6 /* __assign */.pi)(
            (0, tslib_es6 /* __assign */.pi)({}, opts1[k] || {}),
            opts2[k] || {}
          );
          return all;
        }, {});
      ...
      function deepMergeFormatsAndSetTimeZone(f1, timeZone) {
        ...
        return (0, tslib_es6 /* __assign */.pi)(
          (0, tslib_es6 /* __assign */.pi)((0, tslib_es6 /* __assign */.pi)({}, mfFormats), f1),
          {
      ...
      var formatMessage = function (_a, state, messageDescriptor, values, opts) {
        ...
        values = (0, tslib_es6 /* __assign */.pi)(
          (0, tslib_es6 /* __assign */.pi)({}, defaultRichTextElements),
          values || {}
        );
        ...
        if (!message) {
          ...
          if (defaultMessage) {
            try {
              ...
              onError(
                new error /* MessageFormatError */.X9(
                  'Error formatting default message for: "'.concat(id, '", rendering default message verbatim'),
                  locale,
                  messageDescriptor,
                  e
                )
        ...
        try {
          var formatter = state.getMessageFormat(
            ...
            locale,
            formats,
            (0, tslib_es6 /* __assign */.pi)({ formatters: state }, opts || {})
          );
          return formatter.format(values);
        } catch (e) {
          onError(
        ...
        if (defaultMessage) {
          try {
            ...
            onError(
              new error /* MessageFormatError */.X9(
                'Error formatting the default message for: "'.concat(id, '", rendering message verbatim'),
                locale,
                messageDescriptor,
                e
              )
      ...
      var src_utils = __webpack_require__(82644); // CONCATENATED MODULE: ./node_modules/@formatjs/intl/lib/src/number.js
      ...
      var src_error = __webpack_require__(11050); // CONCATENATED MODULE: ./node_modules/@formatjs/intl/lib/src/relativeTime.js
      ...
      function dateTime_getFormatter(_a, type, getDateTimeFormat, options) {
        ...
        var format = options.format;
        var defaults = (0, tslib_es6 /* __assign */.pi)(
          (0, tslib_es6 /* __assign */.pi)({}, timeZone && { timeZone: timeZone }),
      ...
      function formatDateTimeRange(config, getDateTimeFormat) {
        ...
        var filteredOptions = (0, src_utils /* filterProps */.L6)(
          options,
          ...
          return getListFormat(locale, filteredOptions)
            ...
            .map(function (part) {
              return part.type === 'literal'
                ? part
                : (0, tslib_es6 /* __assign */.pi)((0, tslib_es6 /* __assign */.pi)({}, part), {
      ...
      function createIntl(config, cache) {
        ...
        var resolvedConfig = (0, tslib_es6 /* __assign */.pi)(
          (0, tslib_es6 /* __assign */.pi)({}, src_utils /* DEFAULT_INTL_CONFIG */.Z0),
          config
        );
        ...
        if (!locale) {
          if (onError) {
            onError(
              new error /* InvalidConfigError */.OV(
      ...
      var formatters = __webpack_require__(61092); // CONCATENATED MODULE: ./node_modules/react-intl/lib/src/components/provider.js
      /*
      ...
      var provider_formatMessage = function (config, formatters, descriptor, rawValues) {
        ...
        var chunks = formatMessage.apply(
          void 0,
          (0, tslib_es6 /* __spreadArray */.ev)([config, formatters, descriptor, values], rest, false)
        );
      ...
      var provider_createIntl = function (_a, cache) {
        ...
        var coreIntl = createIntl(
          (0, tslib_es6 /* __assign */.pi)(
            (0, tslib_es6 /* __assign */.pi)(
              (0, tslib_es6 /* __assign */.pi)({}, utils /* DEFAULT_INTL_CONFIG */.Z0),
              config
            ),
    ...
    /***/ 64195: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      'use strict';
      ...
      var retryer = __webpack_require__(21216); // CONCATENATED MODULE: ./node_modules/react-query/es/core/query.js
      // TYPES
      ...
      var Query = /*#__PURE__*/ (function () {
        ...
        _proto.setOptions = function setOptions(options) {
          ...
          this.cacheTime = Math.max(
            this.cacheTime || 0,
            (_this$options$cacheTi = this.options.cacheTime) != null ? _this$options$cacheTi : 5 * 60 * 1000
          );
        };
        ...
        _proto.isStaleByTime = function isStaleByTime(staleTime) {
          ...
          return (
            this.state.isInvalidated ||
            !this.state.dataUpdatedAt ||
            !(0, utils /* timeUntilStale */.Kp)(this.state.dataUpdatedAt, staleTime)
          );
        };
      ...
      var subscribable = __webpack_require__(52943); // CONCATENATED MODULE: ./node_modules/react-query/es/core/queryCache.js
      // CLASS
        ...
        _proto.build = function build(client, options, state) {
          ...
          var queryHash =
            (_options$queryHash = options.queryHash) != null
              ? _options$queryHash
              : (0, utils /* hashQueryKeyByOptions */.Rm)(queryKey, options);
      ...
      var core_mutation = __webpack_require__(81262); // CONCATENATED MODULE: ./node_modules/react-query/es/core/mutationCache.js
      // TYPES
      ...
      var infiniteQueryBehavior = __webpack_require__(36997); // CONCATENATED MODULE: ./node_modules/react-query/es/core/queryClient.js
      // TYPES
      ...
      var QueryClient = /*#__PURE__*/ (function () {
        ...
        _proto.mount = function mount() {
          ...
          this.unsubscribeFocus = focusManager /* focusManager.subscribe */.j
            .subscribe(function () {
              if (
                focusManager /* focusManager.isFocused */.j
                  .isFocused() &&
                onlineManager /* onlineManager.isOnline */.N.isOnline()
              ) {
        ...
        _proto.isMutating = function isMutating(filters) {
          return this.mutationCache.findAll(
            (0, esm_extends /* default */.Z)({}, filters, {
              fetching: true,
            })
          ).length;
        };
        ...
        _proto.invalidateQueries = function invalidateQueries(arg1, arg2, arg3) {
          ...
          var refetchFilters = (0, esm_extends /* default */.Z)({}, filters, {
            ...
            active:
              (_ref3 =
                (_filters$refetchActiv = filters.refetchActive) != null ? _filters$refetchActiv : filters.active) !=
              null
                ? _ref3
                : true,
        ...
        _proto.defaultQueryOptions = function defaultQueryOptions(options) {
          ...
          var defaultedOptions = (0, esm_extends /* default */.Z)(
            {},
        ...
        h = (e) => {
          ...
          return /* @__PURE__ */ (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
            children: [
              ...
              !n &&
                /* @__PURE__ */ (0, jsx_runtime.jsx)(HeaderLayout_c, {
                  ...e,
                  sticky: !0,
                  width: a?.width,
                }),
...
`,
    ...
    /***/ 727: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      const n = (0, styled_components__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.ZP)(
          _Box_Box_js__WEBPACK_IMPORTED_MODULE_2__ /* .Box */.x
        )`
...
`,
    ...
    /***/ 33976: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      ...
      var VisuallyHidden = __webpack_require__(63237); // CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/LiveRegions/LiveRegions.js
      const s = () =>
        (0, jsx_runtime.jsxs)(VisuallyHidden /* VisuallyHidden */.T, {
          children: [
            (0, jsx_runtime.jsx)('p', {
              role: 'log',
              'aria-live': 'polite',
...
`,
    ...
    /***/ 30976: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 38992: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      ...
      var common_theme = __webpack_require__(30976); // CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/themes/darkTheme/index.js
      const c = {
        colors: a.color,
        shadows: p.shadow,
    ...
    /***/ 42675: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      ...
      // EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/themes/common-theme.js
      var common_theme = __webpack_require__(30976); // CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/themes/lightTheme/index.js
      const c = {
        colors: e.color,
        shadows: p.shadow,
        ...common_theme /* commonTheme */.x,
    ...
    /***/ 37323: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 41916: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 48077: /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      'use strict';
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
