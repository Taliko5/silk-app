...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [5162],
  {
    /***/ 558: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var upperFirst_default = /*#__PURE__*/ __webpack_require__.n(upperFirst); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/EventInput/EventRow.js
          ...
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsx)('td', {
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Checkbox /* Checkbox */.X, {
                ...
                children: upperFirst_default()(name),
              }),
            }),
            events.map((event) => {
      ...
      /* harmony default export */ const EventInput_EventRow = EventRow; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/EventInput/utils/formatValue.js
      ...
      /* harmony default export */ const utils_formatValue = formatValue; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/EventInput/index.js
...
`;
      ...
      const EventInput = ({ isDraftAndPublish }) => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(StyledTable, {
              children: [
                ...
                /* @__PURE__ */ (0, jsx_runtime.jsx)('tbody', {
                  children: Object.keys(events).map((event) => {
                    return /* @__PURE__ */ (0, jsx_runtime.jsx)(
                      EventInput_EventRow,
                      {
                        disabledEvents,
      ...
      var ComboboxOption = __webpack_require__(90608); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/HeadersInput/keys.js
      const keys = [
        'A-IM',
        'Accept',
        'Accept-Charset',
      ...
      /* harmony default export */ const HeadersInput_keys = keys; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/HeadersInput/Combobox.js
      ...
      /* harmony default export */ const HeadersInput_Combobox = Combobox_Combobox; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/HeadersInput/index.js
      ...
      var Cross = __webpack_require__(70968); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/TriggerContainer/index.js
...
`
      ...
      const Status = ({ isPending, statusCode }) => {
        ...
        if (isPending) {
          return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
            ...
            alignItems: 'center',
            children: [
              /* @__PURE__ */ (0, jsx_runtime.jsx)(Icon, { as: Loader /* default */.Z }),
              /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                children: formatMessage({ id: 'Settings.webhooks.trigger.pending', defaultMessage: 'pending' }),
              }),
            ],
          });
        }
        if (statusCode >= 200 && statusCode < 300) {
          return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
            ...
            alignItems: 'center',
            children: [
              /* @__PURE__ */ (0, jsx_runtime.jsx)(Icon, { as: Check /* default */.Z, color: 'success700' }),
              /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                children: formatMessage({ id: 'Settings.webhooks.trigger.success', defaultMessage: 'success' }),
              }),
            ],
          });
        }
        if (statusCode >= 300) {
          return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
            ...
            alignItems: 'center',
            children: [
              /* @__PURE__ */ (0, jsx_runtime.jsx)(Icon, { as: Cross /* default */.Z, color: 'danger700' }),
              /* @__PURE__ */ (0, jsx_runtime.jsxs)(Typography /* Typography */.Z, {
                children: [formatMessage({ id: 'Settings.error', defaultMessage: 'error' }), ' ', statusCode],
              }),
            ],
          });
        }
        ...
        if (statusCode >= 300) {
          return /* @__PURE__ */ (0, jsx_runtime.jsx)(Flex /* Flex */.k, {
            ...
            children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Flex /* Flex */.k, {
              maxWidth: (0, helper_plugin_esm /* pxToRem */.Q1)(250),
              justifyContent: 'flex-end',
              title: message,
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                ellipsis: true,
            ...
            children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
              ...
              children: [
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                  ...
                  children: formatMessage({ id: 'Settings.webhooks.trigger.cancel', defaultMessage: 'cancel' }),
                }),
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Icon, { as: Cross /* default */.Z, color: 'neutral400' }),
              ],
            }),
          }),
        });
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(Box /* Box */.x, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Grid /* Grid */.r, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, jsx_runtime.jsx)(GridItem /* GridItem */.P, {
                col: 3,
                children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Status, { isPending, statusCode }),
              }),
              /* @__PURE__ */ (0, jsx_runtime.jsx)(GridItem /* GridItem */.P, {
                col: 6,
                children: !isPending
                  ? /* @__PURE__ */ (0, jsx_runtime.jsx)(Message, { statusCode, message })
                  : /* @__PURE__ */ (0, jsx_runtime.jsx)(CancelButton, { onCancel }),
              }),
            ],
          }),
        });
      ...
      var yup_es = __webpack_require__(87561); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/utils/fieldsRegex.js
      const NAME_REGEX = /(^$)|(^[A-Za-z][_0-9A-Za-z ]*$)/;
      const URL_REGEX = /(^$)|((https?:\/\/.*)(d*)\/?(.*))/; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/utils/schema.js
      ...
      const schema = yup_es /* object */
        ...
        .shape({
          ...
          url: yup_es /* string */
            .Z_(helper_plugin_esm /* translatedErrors.string */.I0.string)
            .required(helper_plugin_esm /* translatedErrors.required */.I0.required)
            .matches(URL_REGEX, helper_plugin_esm /* translatedErrors.regex */.I0.regex),
          headers: yup_es /* lazy */
            .Vo((array) => {
      ...
      /* harmony default export */ const utils_schema = schema; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/components/WebhookForm/index.js
      ...
      const WebhookForm = ({
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(formik_esm /* Formik */.J9, {
          ...
          children: ({ handleSubmit: handleSubmit2, errors }) =>
                  ...
                  primaryAction: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, jsx_runtime.jsx)(Button /* Button */.z, {
                        ...
                        variant: 'tertiary',
                        startIcon: /* @__PURE__ */ (0, jsx_runtime.jsx)(Play /* default */.Z, {}),
                    ...
                    children: [
                      showTriggerResponse &&
                        /* @__PURE__ */ (0, jsx_runtime.jsx)('div', {
                          ...
                          children: /* @__PURE__ */ (0, jsx_runtime.jsx)(components_TriggerContainer, {
                      ...
                      /* @__PURE__ */ (0, jsx_runtime.jsx)(Box /* Box */.x, {
                        ...
                        children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, jsx_runtime.jsx)(components_HeadersInput, {}),
                            /* @__PURE__ */ (0, jsx_runtime.jsx)(components_EventInput, {
      ...
      /* harmony default export */ const components_WebhookForm = WebhookForm; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/utils/formatData.js
      ...
      /* harmony default export */ const formatData = cleanData; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Webhooks/EditView/index.js
      ...
      const EditView = () => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Main /* Main */.o, {
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* SettingsPageTitle */.SL, { name: 'Webhooks' }),
            /* @__PURE__ */ (0, jsx_runtime.jsx)(components_WebhookForm, {
              ...{
                handleSubmit,
                data,
                triggerWebhook,
    ...
    /***/ 3672: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var _EditView__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(558);
      ...
      const ProtectedCreateView = () =>
        /* @__PURE__ */ (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
          ...
          {
            permissions:
              _permissions__WEBPACK_IMPORTED_MODULE_3__ /* ["default"].settings.webhooks.create */.Z.settings.webhooks
                .create,
    ...
    /***/ 42122: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ default: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      const ProtectedEditView = () =>
        /* @__PURE__ */ (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
          ...
          {
            permissions:
              _permissions__WEBPACK_IMPORTED_MODULE_3__ /* ["default"].settings.webhooks.update */.Z.settings.webhooks
                .update,
            children: /* @__PURE__ */ (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
              _EditView__WEBPACK_IMPORTED_MODULE_4__ /* ["default"] */.Z,
              {}
