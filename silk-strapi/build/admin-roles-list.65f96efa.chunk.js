...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [3455],
  {
    /***/ 98906: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var hooks = __webpack_require__(48474); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Roles/ListPage/components/EmptyRole/index.js
      ...
      var IconButton = __webpack_require__(12028); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Roles/ListPage/components/RoleRow/index.js
          ...
          Tr.Tr,
          {
            ...
            children: [
              /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Td, {
                maxWidth: (0, helper_plugin_esm /* pxToRem */.Q1)(130),
      ...
      var immer_esm = __webpack_require__(18172); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Roles/ListPage/reducer.js
      const initialState = {
        roleToDelete: null,
      ...
      /* harmony default export */ const ListPage_reducer = reducer; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Roles/ListPage/index.js
      ...
      const RoleListPage = () => {
        const { formatMessage } = (0, useIntl /* default */.Z)();
        const { isLoadingForPermissions, canCreate, canRead, canDelete, canUpdate, isLoading, getData, sortedRoles } =
          useSortedRoles();
        const {
          handleNewRoleClick,
          getIcons,
        ...
        if (isLoadingForPermissions) {
          return /* @__PURE__ */ (0, jsx_runtime.jsx)(Main /* Main */.o, {
            ...
            canRead &&
              /* @__PURE__ */ (0, jsx_runtime.jsxs)(ContentLayout /* ContentLayout */.D, {
                children: [
                  /* @__PURE__ */ (0, jsx_runtime.jsxs)(Table /* Table */.i, {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, jsx_runtime.jsx)(Tbody /* Tbody */.p, {
                        children: sortedRoles?.map((role, index) =>
                          /* @__PURE__ */ (0, jsx_runtime.jsx)(
                            components_RoleRow,
                            {
                              id: role.id,
                  ...
                  !rowCount && !isLoading && /* @__PURE__ */ (0, jsx_runtime.jsx)(EmptyRole, {}),
                ],
              }),
      ...
      /* harmony default export */ const ListPage = RoleListPage; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Roles/ProtectedListPage/index.js
