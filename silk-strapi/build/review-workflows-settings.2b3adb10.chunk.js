...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [8155],
  {
    /***/ 97259: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var constants = __webpack_require__(53616); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/actions/index.js
      ...
      var PlusCircle = __webpack_require__(99782); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/AddStage/AddStage.js
...
`;
      function AddStage({ children, ...props }) {
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(StyledButton, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
            gap: 2,
            children: [
              /* @__PURE__ */ (0, jsx_runtime.jsx)(StyledAddIcon, { 'aria-hidden': true }),
      ...
      var utils = __webpack_require__(47815); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/Stages/Stage/Stage.js
      ...
      function Stage({ id, index, canDelete, canReorder, isOpen: isOpenDefault = false, stagesCount }) {
        ...
        const [{ handlerId, isDragging, handleKeyDown }, stageRef, dropRef, dragRef, dragPreviewRef] = (0,
        hooks /* useDragAndDrop */.Y9)(canReorder, {
          index,
          item: {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Box /* Box */.x, {
          ...
          children: [
            ...
            isDragging
              ? /* @__PURE__ */ (0, jsx_runtime.jsx)(StageDropPreview, {})
              : /* @__PURE__ */ (0, jsx_runtime.jsxs)(Accordion /* Accordion */.U, {
                  ...
                  children: [
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(AccordionToggle /* AccordionToggle */.B, {
                      ...
                      togglePosition: 'left',
                      action: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
                        children: [
                          canDelete &&
      ...
      }).isRequired; // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/Stages/Stage/index.js // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/Stages/Stages.js
...
`;
      function Stages({ stages }) {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
          ...
          width: '100%',
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(StagesContainer, {
              spacing: 4,
              width: '100%',
              children: [
                ...
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Flex /* Flex */.k, {
                  ...
                  children: stages.map((stage, index) => {
                    ...
                    return /* @__PURE__ */ (0, jsx_runtime.jsx)(
                      ...
                      {
                        as: 'li',
                        children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Stage, {
                          id,
                          index,
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsx)(Flex /* Flex */.k, {
              direction: 'column',
              gap: 6,
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(AddStage, {
                type: 'button',
                onClick: () => {
      ...
      var isEqual_default = /*#__PURE__*/ __webpack_require__.n(isEqual); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/reducer/index.js
      const initialState = {
        status: 'loading',
        serverState: {
      ...
      var yup_es = __webpack_require__(87561); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/utils/getWorkflowValidationSchema.js
      ...
      var CarretDown = __webpack_require__(12645); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/components/StageDragPreview/StageDragPreview.js
...
`;
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
          ...
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsx)(Toggle, {
              ...
              width: 6,
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(CarretDown /* default */.Z, { width: `${8 / 16}rem` }),
            }),
            /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, { fontWeight: 'bold', children: name }),
          ],
        });
      }
      ...
      var DragLayer = __webpack_require__(27887); // CONCATENATED MODULE: ./.cache/ee/admin/pages/SettingsPage/pages/ReviewWorkflows/ReviewWorkflows.js
      function renderDragLayerItem({ type, item }) {
        switch (type) {
          case constants /* DRAG_DROP_TYPES.STAGE */.uL.STAGE:
            return /* @__PURE__ */ (0, jsx_runtime.jsx)(StageDragPreview, { ...item });
          default:
            return null;
        }
      }
      function ReviewWorkflowsPage() {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* CheckPagePermissions */.O4, {
          permissions: permissions /* default.settings.review-workflows.main */.Z.settings['review-workflows'].main,
          children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Layout /* Layout */.A, {
            children: [
              ...
              /* @__PURE__ */ (0, jsx_runtime.jsxs)(Main /* Main */.o, {
                tabIndex: -1,
                children: [
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(DragLayer /* DragLayer */.r, {
                    renderItem: renderDragLayerItem,
                  }),
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(formik_esm /* FormikProvider */.Hy, {
                    value: formik,
                    children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(formik_esm /* Form */.l0, {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, jsx_runtime.jsxs)(ContentLayout /* ContentLayout */.D, {
                          children: [
                            ...
                            /* @__PURE__ */ (0, jsx_runtime.jsx)(Stages, { stages: formik.values?.stages }),
                          ],
                        }),
                      ],
                    }),
