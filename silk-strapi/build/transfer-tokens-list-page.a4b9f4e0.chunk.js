...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [9600],
  {
    /***/ 56856: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      ...
      var useIntl = __webpack_require__(86896); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/components/Tokens/Table/DeleteButton/index.js
      ...
      var styled_components_browser_esm = __webpack_require__(71997); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/components/Tokens/Table/DefaultButton/index.js
      const MESSAGES_MAP = {
        edit: {
...
`;
      const DefaultButton = ({ tokenName, tokenId, buttonType, children }) => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(LinkStyled, {
          to: `${pathname}/${tokenId}`,
      ...
      /* harmony default export */ const Table_DefaultButton = DefaultButton; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/components/Tokens/Table/UpdateButton/index.js

      const UpdateButton = ({ tokenName, tokenId }) => {
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(Table_DefaultButton, {
          tokenName,
          tokenId,
      ...
      var Eye = __webpack_require__(8934); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/components/Tokens/Table/ReadButton/index.js
      ...
      /* harmony default export */ const Table_ReadButton = ReadButton; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/components/Tokens/Table/index.js

      const Table = ({ permissions, headers, contentType, isLoading, tokens, onConfirmDelete, tokenType }) => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* DynamicTable */.tM, {
          headers,
          contentType,
          rows: tokens,
          withBulkActions,
          isLoading,
          onConfirmDelete,
          children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Tbody /* Tbody */.p, {
                ...
                Tr.Tr,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Td, {
                      children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                        textColor: 'neutral800',
                        children: /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* RelativeTime */.ij, {
                    ...
                    withBulkActions &&
                      /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Td, {
                        children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
                          ...
                          children: [
                            canUpdate &&
                              /* @__PURE__ */ (0, jsx_runtime.jsx)(Table_UpdateButton, {
                                tokenName: token.name,
                                tokenId: token.id,
                              }),
                            !canUpdate &&
                              canRead &&
                              /* @__PURE__ */ (0, jsx_runtime.jsx)(Table_ReadButton, {
                                tokenName: token.name,
                                tokenId: token.id,
                              }),
                            canDelete &&
                              /* @__PURE__ */ (0, jsx_runtime.jsx)(Table_DeleteButton, {
                                tokenName: token.name,
    ...
    /***/ 70798: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var Plus = __webpack_require__(96315); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/ListView/utils/tableHeaders.js
      const tableHeaders = [
        {
          name: 'name',
          key: 'name',
      ...
      var constants = __webpack_require__(47670); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/ListView/index.js
      const TransferTokenListView = () => {
        ...
        const isLoading =
          canRead && ((status !== 'success' && status !== 'error') || (status === 'success' && isFetching));
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(ContentLayout /* ContentLayout */.D, {
              children: [
                ...
                shouldDisplayNoContentWithCreationButton &&
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* NoContent */.dJ, {
                    content: {
      ...
      /* harmony default export */ const ListView = TransferTokenListView; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/TransferTokens/ProtectedListView/index.js
      ...
      const ProtectedTransferTokenListView = () =>
        /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* CheckPagePermissions */.O4, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsx)(ListView, {}),
        });
