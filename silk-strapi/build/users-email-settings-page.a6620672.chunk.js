...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [8418],
  {
    /***/ 95972: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var utils = __webpack_require__(89031); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/EmailTemplates/utils/api.js
      ...
      var Check = __webpack_require__(85018); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/EmailTemplates/components/EmailTable.js
      const EmailTable = ({ canUpdate, onEditClick }) => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Table /* Table */.i, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(Tbody /* Tbody */.p, {
              children: [
                /* @__PURE__ */ (0, jsx_runtime.jsxs)(Tr.Tr, {
                  ...(0, helper_plugin_esm /* onRowClick */.X7)({ fn: () => onEditClick('reset_password') }),
                  children: [
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Td, {
                      children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Icon /* Icon */.J, {
                        children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Refresh /* default */.Z, {
                    ...
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Td, {
                      ...
                      children: /* @__PURE__ */ (0, jsx_runtime.jsx)(IconButton /* IconButton */.h, {
                        ...
                        noBorder: true,
                        icon: canUpdate && /* @__PURE__ */ (0, jsx_runtime.jsx)(Pencil /* default */.Z, {}),
                      }),
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, jsx_runtime.jsxs)(Tr.Tr, {
                  ...(0, helper_plugin_esm /* onRowClick */.X7)({ fn: () => onEditClick('email_confirmation') }),
                  children: [
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(Cell.Td, {
                      children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Icon /* Icon */.J, {
      ...
      var yup_es = __webpack_require__(87561); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/EmailTemplates/utils/schema.js
      const schema = yup_es /* object */
        .Ry()
        .shape({
          options: yup_es /* object */
            .Ry()
            .shape({
              from: yup_es /* object */
                .Ry()
                ...
                .required(),
              response_email: yup_es /* string */
                .Z_()
                .email(helper_plugin_esm /* translatedErrors.email */.I0.email),
              object: yup_es /* string */
                .Z_()
                .required(helper_plugin_esm /* translatedErrors.required */.I0.required),
              message: yup_es /* string */
                .Z_()
                .required(helper_plugin_esm /* translatedErrors.required */.I0.required),
            })
            .required(helper_plugin_esm /* translatedErrors.required */.I0.required),
        });
      /* harmony default export */ const utils_schema = schema; // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/EmailTemplates/components/EmailForm.js
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(ModalLayout /* ModalLayout */.P, {
          ...
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsx)(ModalHeader /* ModalHeader */.x, {
              children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Breadcrumbs /* Breadcrumbs */.O, {
                label: `${formatMessage({
                  id: (0, utils /* getTrad */.OB)('PopUpForm.header.edit.email-templates'),
                  defaultMessage: 'Edit email template',
                })}, ${formatMessage({
                ...
                children: [
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(Breadcrumbs /* Crumb */.$, {
                    children: formatMessage({
                      id: (0, utils /* getTrad */.OB)('PopUpForm.header.edit.email-templates'),
                      defaultMessage: 'Edit email template',
                    }),
      ...
      /* harmony default export */ const components_EmailForm = EmailForm; // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/EmailTemplates/index.js
      ...
      const ProtectedEmailTemplatesPage = () =>
        /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* CheckPagePermissions */.O4, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsx)(EmailTemplatesPage, {}),
        });
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Main /* Main */.o, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(ContentLayout /* ContentLayout */.D, {
              children: [
                /* @__PURE__ */ (0, jsx_runtime.jsx)(components_EmailTable, {
                  onEditClick: handleEditClick,
                  canUpdate,
                }),
                isModalOpen &&
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(components_EmailForm, {
