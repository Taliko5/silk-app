...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [3981],
  {
    /***/ 67994: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var utils = __webpack_require__(680); // CONCATENATED MODULE: ./node_modules/react-intl/lib/src/components/message.js
      /*
      ...
      function areEqual(prevProps, nextProps) {
        var values = prevProps.values,
          otherProps = (0, tslib_es6 /* __rest */._T)(prevProps, ['values']);
        var nextValues = nextProps.values,
          nextOtherProps = (0, tslib_es6 /* __rest */._T)(nextProps, ['values']);
        return (
          (0, utils /* shallowEqual */.wU)(nextValues, values) &&
      ...
      var GridItem = __webpack_require__(74571); // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/assets/corner-ornament.svg
      ...
      var hooks = __webpack_require__(48474); // CONCATENATED MODULE: ./.cache/admin/src/components/GuidedTour/utils/isGuidedTourCompleted.js
      const isGuidedTourCompleted = (guidedTourState) =>
        Object.entries(guidedTourState).every(([, section]) => Object.entries(section).every(([, step]) => step));
      ...
      var constants = __webpack_require__(99872); // CONCATENATED MODULE: ./.cache/admin/src/components/GuidedTour/Homepage/components/Step.js
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
              children: [
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Box /* Box */.x, {
                  ...
                  marginRight: 5,
                  children: /* @__PURE__ */ (0, jsx_runtime.jsx)(StepNumber /* default */.Z, {
                    type,
                    number,
                  }),
                }),
                    ...
                    /* @__PURE__ */ (0, jsx_runtime.jsx)(StepLine /* default */.Z, {
                      ...
                      minHeight:
                        type === constants /* IS_ACTIVE */.lW
                          ? (0, helper_plugin_esm /* pxToRem */.Q1)(85)
                          : (0, helper_plugin_esm /* pxToRem */.Q1)(65),
                    }),
                }),
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Box /* Box */.x, {
                  marginTop: 2,
                  children: type === constants /* IS_ACTIVE */.lW && content,
                }),
              ],
            }),
          ],
      ...
      StepHomepage.propTypes = {
        ...
        type: prop_types_default().oneOf([
          constants /* IS_ACTIVE */.lW,
          constants /* IS_DONE */.hx,
          constants /* IS_NOT_DONE */.VM,
        ]),
        hasLine: prop_types_default().bool,
      };
      /* harmony default export */ const Step = StepHomepage; // CONCATENATED MODULE: ./.cache/admin/src/components/GuidedTour/Homepage/components/Stepper.js
      ...
      var layout = __webpack_require__(64729); // CONCATENATED MODULE: ./.cache/admin/src/components/GuidedTour/Homepage/index.js
      const GuidedTourHomepage = () => {
        ...
        const sections = Object.entries(layout /* default */.Z).map(([key, val]) => ({
          ...
          content: /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* LinkButton */.Qj, {
          ...
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Stepper, {
                  sections,
      ...
      var Link = __webpack_require__(36182); // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/Discord.js
      const l = (c) =>
        ...
        t = l; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/Reddit.js
      ...
      const a = (l) =>
        ...
        d = a; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/Strapi.js
      ...
      const e = (h) =>
        ...
        i = e; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/Twitter.js
      ...
      const Twitter_i = (e) =>
        ...
        o = Twitter_i; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/Discourse.js
      ...
      var ExternalLink = __webpack_require__(17772); // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/SocialLinks.js
...
`;
      const socialLinks = [
        ...
        },
        {
          ...
          icon: /* @__PURE__ */ (0, jsx_runtime.jsx)(StyledStrapi, {}),
          alt: 'blog',
        },
        {
          name: {
...
`;
      const SocialLinks = () => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Box /* Box */.x, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsx)(GridGap, {
              children: socialLinksExtended.map(({ icon, link, name }) => {
                return /* @__PURE__ */ (0, jsx_runtime.jsx)(
                  GridItem /* GridItem */.P,
                  {
                    col: 6,
                    s: 12,
                    children: /* @__PURE__ */ (0, jsx_runtime.jsx)(LinkCustom, {
                      size: 'L',
                      startIcon: icon,
                      variant: 'tertiary',
                      href: link,
      ...
      /* harmony default export */ const HomePage_SocialLinks = SocialLinks; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/HomeHeader.js
...
`;
            ...
            children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
              ...
              children: [
                /* @__PURE__ */ (0, jsx_runtime.jsx)(Typography /* Typography */.Z, {
                  as: 'h1',
                  variant: 'alpha',
                  children: hasCreatedContentType
                    ? formatMessage({
                ...
                /* @__PURE__ */ (0, jsx_runtime.jsx)(WordWrap, {
                  textColor: 'neutral600',
                  variant: 'epsilon',
                  children: hasCreatedContentType
                    ? formatMessage({
      ...
      /* harmony default export */ const HomePage_HomeHeader = HomeHeader; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/InformationSquare.js

      const InformationSquare_h = (t) =>
          /* @__PURE__ */ (0, jsx_runtime.jsxs)('svg', {
            xmlns: 'http://www.w3.org/2000/svg',
            width: '1rem',
            height: '1rem',
        ...
        InformationSquare_e = InformationSquare_h; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/CodeSquare.js

      const CodeSquare_o = (l) =>
          /* @__PURE__ */ (0, jsx_runtime.jsxs)('svg', {
            xmlns: 'http://www.w3.org/2000/svg',
            width: '1rem',
            height: '1rem',
        ...
        CodeSquare_t = CodeSquare_o; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/PlaySquare.js

      const PlaySquare_t = (e) =>
          /* @__PURE__ */ (0, jsx_runtime.jsxs)('svg', {
            xmlns: 'http://www.w3.org/2000/svg',
            width: '1rem',
            height: '1rem',
        ...
        PlaySquare_o = PlaySquare_t; // CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/FeatherSquare.js

      const FeatherSquare_t = (e) =>
          /* @__PURE__ */ (0, jsx_runtime.jsxs)('svg', {
            xmlns: 'http://www.w3.org/2000/svg',
            width: '1rem',
            height: '1rem',
        ...
        FeatherSquare_h = FeatherSquare_t; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/assets/strapi-cloud-background.png

      const strapi_cloud_background_namespaceObject = __webpack_require__.p + '27d16aefee06412db90a.png'; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/assets/strapi-cloud-icon.svg
      const strapi_cloud_icon_namespaceObject = __webpack_require__.p + 'bb3108f7fd1e6179bde1.svg'; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/assets/strapi-cloud-flags.svg
      const strapi_cloud_flags_namespaceObject = __webpack_require__.p + 'bb4d0d527bdfb161bc5a.svg'; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/CloudBox.js
...
`;
      const CloudBox = () => {
        const { formatMessage } = (0, useIntl /* default */.Z)();
        const { trackUsage } = (0, helper_plugin_esm /* useTracking */.rS)();
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(BlockLink, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
            ...
            gap: 6,
            children: [
              /* @__PURE__ */ (0, jsx_runtime.jsx)(CloudCustomWrapper, {
                backgroundImage: strapi_cloud_background_namespaceObject,
                hasRadius: true,
                padding: 3,
                children: /* @__PURE__ */ (0, jsx_runtime.jsx)(CloudIconWrapper, {
              ...
              /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, jsx_runtime.jsx)(Box /* Box */.x, {
                    src: strapi_cloud_flags_namespaceObject,
                    position: 'absolute',
                    top: 0,
                    right: 0,
                    as: 'img',
      ...
      /* harmony default export */ const HomePage_CloudBox = CloudBox; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/ContentBlocks.js
...
`;
      const ContentBlocks = () => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsxs)(Flex /* Flex */.k, {
          ...
          gap: 5,
          children: [
            /* @__PURE__ */ (0, jsx_runtime.jsx)(HomePage_CloudBox, {}),
            /* @__PURE__ */ (0, jsx_runtime.jsx)(ContentBlocks_BlockLink, {
              ...
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* ContentBox */.Y_, {
                ...
                icon: /* @__PURE__ */ (0, jsx_runtime.jsx)(InformationSquare_e, {}),
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsx)(ContentBlocks_BlockLink, {
              ...
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* ContentBox */.Y_, {
                ...
                icon: /* @__PURE__ */ (0, jsx_runtime.jsx)(CodeSquare_t, {}),
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsx)(ContentBlocks_BlockLink, {
              ...
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* ContentBox */.Y_, {
                ...
                icon: /* @__PURE__ */ (0, jsx_runtime.jsx)(PlaySquare_o, {}),
            ...
            /* @__PURE__ */ (0, jsx_runtime.jsx)(ContentBlocks_BlockLink, {
              ...
              children: /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* ContentBox */.Y_, {
                ...
                icon: /* @__PURE__ */ (0, jsx_runtime.jsx)(FeatherSquare_h, {}),
      ...
      /* harmony default export */ const HomePage_ContentBlocks = ContentBlocks; // CONCATENATED MODULE: ./.cache/admin/src/pages/HomePage/index.js
      ...
      const LogoContainer = /*#__PURE__*/ (0, styled_components_browser_esm /* default */.ZP)(
        Box /* Box */.x
      ).withConfig({ displayName: 'HomePage__LogoContainer', componentId: 'sc-1md9zz4-0' })(
        ['position:absolute;top:0;right:0;img{width:', 'rem;}'],
        150 / 16
      );
      const HomePage = () => {
        ...
        return /*#__PURE__*/ react.createElement(
          ...
          /*#__PURE__*/ react.createElement(
            message,
            { id: 'HomePage.helmet.title', defaultMessage: 'Homepage' },
            (title) => /*#__PURE__*/ react.createElement(Helmet /* Helmet */.q, { title: title[0] })
          ),
          /*#__PURE__*/ react.createElement(
            Main /* Main */.o,
            null,
              ...
              /*#__PURE__*/ react.createElement(
                ...
                /*#__PURE__*/ react.createElement(
                  ...
                  showGuidedTour
                    ...
                    : /*#__PURE__*/ react.createElement(HomePage_ContentBlocks, null)
                ),
                /*#__PURE__*/ react.createElement(
                  GridItem /* GridItem */.P,
                  { col: 4, s: 12 },
      ...
      /* harmony default export */ const pages_HomePage = /*#__PURE__*/ (0, react.memo)(HomePage);
