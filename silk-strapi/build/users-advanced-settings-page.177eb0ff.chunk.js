...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [9460],
  {
    /***/ 98352: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var utils = __webpack_require__(89031); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/AdvancedSettings/utils/layout.js
      const layout = [
        {
          intlLabel: {
      ...
      var yup_es = __webpack_require__(87561); // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/AdvancedSettings/utils/schema.js
      const URL_REGEX = new RegExp('(^$)|((.+:\\/\\/.*)(d*)\\/?(.*))');
      const schema = yup_es /* object */
        .Ry()
        .shape({
          email_confirmation_redirection: yup_es /* mixed */
            .nK()
          ...
          email_reset_password: yup_es /* string */
      ...
      /* harmony default export */ const utils_schema = schema; // CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/AdvancedSettings/utils/api.js
      ...
      const ProtectedAdvancedSettingsPage = () =>
        /* @__PURE__ */ (0, jsx_runtime.jsx)(helper_plugin_esm /* CheckPagePermissions */.O4, {
          ...
          children: /* @__PURE__ */ (0, jsx_runtime.jsx)(AdvancedSettingsPage, {}),
        });
                                  ...
                                  children: /* @__PURE__ */ (0, jsx_runtime.jsx)(Select /* Select */.P, {
                                    ...
                                    children: data.roles.map((role) => {
                                      return /* @__PURE__ */ (0, jsx_runtime.jsx)(
                                        Option /* Option */.W,
                                        { value: role.type, children: role.name },
                                        role.type
                                      );
                                    }),
                                  }),
