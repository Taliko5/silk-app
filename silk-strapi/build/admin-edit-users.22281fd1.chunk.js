...
(globalThis['webpackChunksilk_strapi'] = globalThis['webpackChunksilk_strapi'] || []).push([
  [4263],
  {
    /***/ 22282: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var utils = __webpack_require__(19631); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/EditPage/utils/api.js
      ...
      var SelectRoles = __webpack_require__(81288); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/EditPage/index.js
      const MagicLink = (() => {
      ...
      const EditPage = (_ref) => {
        ...
        const { status, data } = (0, es.useQuery)(['user', id], () => fetchUser(id), {
          retry: false,
          onError(err) {
            const status = err.response.status; // Redirect the use to the homepage if is not allowed to read
            if (status === 403) {
              toggleNotification({
                type: 'info',
                message: {
        ...
        const handleSubmit = async (body, actions) => {
          ...
          try {
            ...
            const userInfos = helper_plugin_esm /* auth.getUserInfo */.I8.getUserInfo(); // The user is updating himself
            if (id.toString() === userInfos.id.toString()) {
              helper_plugin_esm /* auth.setUserInfo */.I8.setUserInfo(data);
              const userDisplayName =
                get_default()(body, 'username') || (0, utils /* getFullName */.Pp)(body.firstname, body.lastname);
        ...
        const initialData = Object.keys(pick_default()(data, fieldsToPick)).reduce((acc, current) => {
          if (current === 'roles') {
            acc[current] = (data?.roles || []).map((_ref2) => {
              let { id } = _ref2;
              return id;
            });
            return acc;
        ...
        const headerLabelName =
          initialData.username || (0, utils /* getFullName */.Pp)(initialData.firstname, initialData.lastname);
        ...
        return /*#__PURE__*/ react.createElement(
          ...
          /*#__PURE__*/ react.createElement(
            ...
            (_ref3) => {
              let { errors, values, handleChange, isSubmitting } = _ref3;
              return /*#__PURE__*/ react.createElement(
                ...
                /*#__PURE__*/ react.createElement(
                  ...
                  /*#__PURE__*/ react.createElement(
                    Flex /* Flex */.k,
                    { direction: 'column', alignItems: 'stretch', gap: 7 },
                    /*#__PURE__*/ react.createElement(
                      Box /* Box */.x,
                      {
                        background: 'neutral0',
                      ...
                      /*#__PURE__*/ react.createElement(
                        Flex /* Flex */.k,
                        { direction: 'column', alignItems: 'stretch', gap: 4 },
                        /*#__PURE__*/ react.createElement(
      ...
      EditPage.propTypes = { canUpdate: prop_types_default().bool.isRequired };
      /* harmony default export */ const Users_EditPage = EditPage; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/ProtectedEditPage/index.js
      const ProtectedEditPage = () => {
        ...
        return /* @__PURE__ */ (0, jsx_runtime.jsx)(Users_EditPage, { canUpdate });
      };
...
`;
    ...
    /***/ 17405: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      __webpack_require__.d(__webpack_exports__, {
        YM: () => /* reexport */ edit,
        Rw: () => /* reexport */ profile,
      ...
      // EXTERNAL MODULE: ./node_modules/@strapi/helper-plugin/build/helper-plugin.esm.js + 25 modules
      var helper_plugin_esm = __webpack_require__(548); // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/utils/validations/users/profile.js
      const commonUserSchema = {
        ...
        confirmPassword: es /* string */
          ...
          .when('password', (password, passSchema) => {
            return password
              ? passSchema.required(helper_plugin_esm /* translatedErrors.required */.I0.required)
              : passSchema;
          }),
      };
      const schema = {
        ...commonUserSchema,
        currentPassword: es /* string */
          .Z_()
        ...
        preferedLanguage: es /* string */
          .Z_()
          .nullable(),
      };
      /* harmony default export */ const profile = schema; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/utils/validations/users/roles.js
      ...
      /* harmony default export */ const roles = roles_schema; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/utils/validations/users/edit.js

      const edit_schema = es /* object */
        .Ry()
        .shape({
          ...commonUserSchema,
          isActive: es /* bool */
      ...
      /* harmony default export */ const edit = edit_schema; // CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/utils/validations/users/index.js
