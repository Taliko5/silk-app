...
import { Box, HeaderLayout, ContentLayout, ActionLayout, Layout, Main } from '@strapi/design-system';
    ...
    <Main aria-busy={isLoading}>
      ...
      <ContentLayout canRead={canReadAuditLogs}>
        <DynamicTable
          ...
          isLoading={isLoading}
        >
          <TableRows headers={headers} rows={auditLogs?.results || []} onOpenModal={(id) => setQuery({ id })} />
        </DynamicTable>
