...
import { useCMEditViewDataManager, useFetchClient, useNotification, useAPIErrorHandler } from '@strapi/helper-plugin';
        ...
        <Flex position="relative" gap={1}>
          {availability && !regenerateLabel && (
            ...
            >
              ...
              <Typography textColor={availability.isAvailable ? 'success600' : 'danger600'} variant="pi">
                {formatMessage(
