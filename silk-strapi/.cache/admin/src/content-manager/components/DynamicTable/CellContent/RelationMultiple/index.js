import { Badge, Box, Flex, Loader, MenuItem, SimpleMenu, Typography, useNotifyAT } from '@strapi/design-system';
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  return (
    <Box {...stopPropagation}>
      <SimpleMenu label={Label} size="S" onOpen={() => setIsOpen(true)} onClose={() => setIsOpen(false)}>
        {status !== 'success' && (
