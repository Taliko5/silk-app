  ...
  produce(state, (draftState) => {
    switch (action.type) {
      ...
      case 'LOAD_RELATION': {
        ...
        const keys = generateNKeysBetween(null, modifiedDataRelations[0]?.__temp_key__, valuesToLoad.length);
        ...
        set(draftState, initialDataPath, uniqBy([...valuesWithKeys, ...initialDataRelations], 'id'));
         ...
         */
        set(draftState, modifiedDataPath, uniqBy([...valuesWithKeys, ...modifiedDataRelations], 'id'));
      ...
      case 'INIT_FORM': {
        ...
        const mergedDataWithTmpKeys = findComponentsAndReplaceWithTempKey(mergedDataWithPreparedRelations, attributes, {
      ...
      case 'MOVE_FIELD': {
        ...
        const updatedValue = moveFields(currentValue, action.dragIndex, action.overIndex, valueToInsert);
