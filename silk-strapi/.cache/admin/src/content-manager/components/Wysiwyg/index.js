...
import { markdownHandler, listHandler, titleHandler, insertFile, quoteAndCodeHandler } from './utils/utils';
...
const Wysiwyg = ({ hint, disabled, error, intlLabel, labelAction, name, onChange, placeholder, value, required }) => {
  ...
  return (
    <>
      <Flex direction="column" alignItems="stretch" gap={1}>
        ...
        <EditorLayout isExpandMode={isExpandMode} error={error} previewContent={value} onCollapse={handleToggleExpand}>
          <WysiwygNav
      ...
      {mediaLibVisible && <MediaLibraryDialog onClose={handleToggleMediaLib} onSelectAssets={handleSelectAssets} />}
    </>
  );
};
