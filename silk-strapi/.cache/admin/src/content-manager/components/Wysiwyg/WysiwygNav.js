...
import { FocusTrap, Button, IconButtonGroup, Option, Select, Popover, Flex } from '@strapi/design-system';
import {
  Bold,
  Italic,
  Underline,
  ...
  return (
    <Flex padding={2} background="neutral100" justifyContent="space-between">
      <StyledFlex>
        ...
        <MoreButton ref={buttonMoreRef} onClick={handleTogglePopover} id="more" label="More" icon={<More />} />
        {visiblePopover && (
