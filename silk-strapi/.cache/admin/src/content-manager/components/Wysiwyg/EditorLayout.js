...
export const EditorLayout = ({ children, isExpandMode, error, previewContent, onCollapse }) => {
            ...
            >
              <Flex height="100%" alignItems="flex-start">
                ...
                <Flex alignItems="start" direction="column" flex={1} height="100%" width="100%">
                  <Flex height={pxToRem(48)} background="neutral100" justifyContent="flex-end" shrink={0} width="100%">
  ...
  return (
    <Box borderColor={error ? 'danger600' : 'neutral200'} borderStyle="solid" borderWidth="1px" hasRadius>
      {children}
    </Box>
  );
};
