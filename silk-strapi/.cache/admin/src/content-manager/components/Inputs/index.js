...
import { connect, generateOptions, getInputType, getStep, select, VALIDATIONS_TO_OMIT } from './utils';
...
function Inputs({
  ...
  const options = useMemo(() => generateOptions(fieldSchema.enum || [], isRequired), [fieldSchema, isRequired]);
