...
const DraggedItem = ({
  ...
  const displayedValue = toString(get(modifiedData, [...componentFieldName.split('.'), mainField], ''));
    ...
    <Box ref={composedBoxRefs}>
      {isDragging ? (
        ...
        <Accordion expanded={isOpen} onToggle={onClickToggle} id={componentFieldName} size="S">
          ...
          />
          <AccordionContent>
            <Flex direction="column" alignItems="stretch" background="neutral100" padding={6} gap={6}>
