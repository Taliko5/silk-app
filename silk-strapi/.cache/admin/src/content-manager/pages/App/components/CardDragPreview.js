...
const DragButton = styled(ActionBox)`
  border-right: 1px solid ${({ theme, isSibling }) => (isSibling ? theme.colors.neutral150 : theme.colors.primary200)};
...
const FieldContainer = styled(Flex)`
  border: 1px solid ${({ theme, isSibling }) => (isSibling ? theme.colors.neutral150 : theme.colors.primary200)};
  ...
  return (
    ...
    >
      <Flex gap={3}>
        ...
        <TypographyMaxWidth textColor={isSibling ? undefined : 'primary600'} fontWeight="bold" ellipsis>
          {labelField}
        </TypographyMaxWidth>
      </Flex>
