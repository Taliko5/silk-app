import { useNotification, useRBACProvider, useStrapiApp, useFetchClient } from '@strapi/helper-plugin';
...
const useContentManagerInitData = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const { ctLinks: authorizedCollectionTypeLinks } = runHookWaterfall(MUTATE_COLLECTION_TYPES_LINKS, {
