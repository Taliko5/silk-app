...
const EditFieldForm = ({ attributes, fieldForm, fieldToEdit, onCloseModal, onChangeEditLabel, onSubmit, type }) => {
    ...
    <ModalLayout onClose={onCloseModal} labelledBy="title">
      <form onSubmit={onSubmit}>
        ...
        <ModalFooter
          ...
          endActions={<Button type="submit">{formatMessage({ id: 'global.finish', defaultMessage: 'Finish' })}</Button>}
        />
      </form>
    </ModalLayout>
  );
