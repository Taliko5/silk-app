  ...
  produce(state, (draftState) => {
    ...
    switch (action.type) {
      ...
      case 'MOVE_FIELD': {
        ...
        set(draftState, layoutFieldListPath, arrayMoveItem(layoutFieldList, originalIndex, atIndex));
        break;
      }
      case 'ON_CHANGE': {
      ...
      case 'SET_FIELD_TO_EDIT': {
        ...
        draftState.fieldForm.label = get(draftState, ['modifiedData', 'metadatas', fieldToEdit, 'list', 'label'], '');
