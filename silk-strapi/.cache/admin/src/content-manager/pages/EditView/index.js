...
import { CheckPermissions, useTracking, LinkButton, LoadingIndicatorPage } from '@strapi/helper-plugin';
                          ...
                          >
                            <Flex direction="column" alignItems="stretch" gap={6}>
                              {row.map((grid, gridRowIndex) => (
                                <GridRow columns={grid} customFieldInputs={lazyComponentStore} key={gridRowIndex} />
                              ))}
                            </Flex>
                          </Box>
                        );
                    ...
                    <Flex direction="column" alignItems="stretch" gap={2}>
                      ...
                      <Box as="aside" aria-labelledby="links">
                        <Flex direction="column" alignItems="stretch" gap={2}>
                          ...
                          {allowedActions.canDelete && !isCreatingEntry && <DeleteLink onDelete={onDelete} />}
                        </Flex>
                      </Box>
                    </Flex>
                  </GridItem>
