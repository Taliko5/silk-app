...
function ListView({
  ...
  return (
    <Main aria-busy={isLoading}>
      ...
      />
      {!canRead && <ActionLayout endActions={<InjectionZone area="contentManager.listView.actions" />} />}
      {canRead && (
        <ActionLayout
          endActions={
            <>
          ...
          startActions={
            <>
              ...
              {isFilterable && <AttributeFilter contentType={contentType} slug={slug} metadatas={metadatas} />}
            </>
          }
        />
      )}
...
ListView.propTypes = {
  ...
  pagination: PropTypes.shape({ total: PropTypes.number.isRequired, pageCount: PropTypes.number }).isRequired,
