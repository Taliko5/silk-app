    ...
    <>
      ...
      <Flex>
        <Flex marginRight={8} minWidth={pxToRem(30)}>
          <StepNumberWithPadding number={sectionIndex + 1} type={hasStepsBefore ? IS_DONE : IS_ACTIVE} />
        </Flex>
        ...
        <Flex marginRight={8} direction="column" justifyContent="center" minWidth={pxToRem(30)}>
          {hasSectionAfter && (
            <>
              ...
              {hasStepsBefore && <StepNumberWithPadding number={nextSectionIndex + 1} type={IS_ACTIVE} last />}
            </>
          )}
        </Flex>
        <Box>
