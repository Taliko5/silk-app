...
const ApiTokenPermissionsContextProvider = ({ children, ...rest }) => {
  return <ApiTokenPermissionsContext.Provider value={rest}>{children}</ApiTokenPermissionsContext.Provider>;
};
...
export { ApiTokenPermissionsContext, ApiTokenPermissionsContextProvider, useApiTokenPermissionsContext };
