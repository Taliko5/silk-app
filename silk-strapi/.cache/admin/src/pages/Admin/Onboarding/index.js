...
const Onboarding = () => {
  ...
  return (
    <Box as="aside" position="fixed" bottom={2} right={2}>
      ...
      {isOpen && (
        <Portal>
          <PopoverPrimitives.Content padding={0} source={triggerRef} placement="top-end" spacing={12}>
            <FocusTrap onEscape={handlePopoverVisibility}>
              <Flex justifyContent="space-between" paddingBottom={5} paddingRight={6} paddingLeft={6} paddingTop={6}>
              ...
              <Flex direction="column" alignItems="stretch" gap={2} paddingLeft={5} paddingTop={2} paddingBottom={5}>
