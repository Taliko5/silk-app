    ...
    >
      <Box>
        <Flex direction="row" justifyContent="space-between" alignItems="flex-start">
          <Box as="img" src={attributes.logo.url} alt={`${attributes.name} logo`} hasRadius width={11} height={11} />
          <PackageStats
            ...
            <Flex alignItems="center">
              ...
              {attributes.madeByStrapi && (
                <Tooltip description={madeByStrapiMessage}>
                  <Flex>
                    <Box as="img" src={StrapiLogo} alt={madeByStrapiMessage} marginLeft={1} width={6} height="auto" />
                  </Flex>
                </Tooltip>
              )}
            </Flex>
