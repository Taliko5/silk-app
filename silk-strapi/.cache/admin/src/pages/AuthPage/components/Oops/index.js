...
import UnauthenticatedLayout, { Column, LayoutContent } from '../../../../layouts/UnauthenticatedLayout';
    ...
    <UnauthenticatedLayout>
      <Main>
        ...
        <Flex justifyContent="center">
          <Box paddingTop={4}>
            <Link to="/auth/login">{formatMessage({ id: 'Auth.link.signin', defaultMessage: 'Sign in' })}</Link>
          </Box>
        </Flex>
      </Main>
    </UnauthenticatedLayout>
