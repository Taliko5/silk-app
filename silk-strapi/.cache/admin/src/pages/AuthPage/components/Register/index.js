...
import { Box, Main, Flex, Button, TextInput, Checkbox, Grid, GridItem, Typography } from '@strapi/design-system';
    ...
    if (registrationToken) {
      const getData = async () => {
        try {
          const {
            data: { data },
          } = await axios.get(`${strapi.backendURL}/admin/registration-info?registrationToken=${registrationToken}`);
          ...
          onSubmit={async (data, formik) => {
            ...
            try {
              ...
              if (registrationToken) {
                ...
                onSubmit({ userInfo: omit(normalizedData, ['registrationToken']), registrationToken }, formik);
              } else {
