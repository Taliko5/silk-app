      ...
      primaryAction={
        canEditInputs ? (
          <Flex gap={2}>
            ...
            <Button disabled={isSubmitting} loading={isSubmitting} startIcon={<Check />} type="submit" size="S">
              {formatMessage({
                id: 'global.save',
                defaultMessage: 'Save',
              })}
          ...
          canRegenerate &&
          token?.id && <Regenerate onRegenerate={handleRegenerate} idToRegenerate={token?.id} backUrl={regenerateUrl} />
        )
      }
      navigationAction={
