...
import { RelativeTime, onRowClick, pxToRem, DynamicTable, useQueryParams, useTracking } from '@strapi/helper-plugin';
              ...
              {withBulkActions && (
                <Td>
                  <Flex justifyContent="end">
                    ...
                    {!canUpdate && canRead && <ReadButton tokenName={token.name} tokenId={token.id} />}
                    {canDelete && (
                      <DeleteButton
