const defaultRoutes = [
  {
    async Component() {
      const component = await import(/* webpackChunkName: "admin-roles-list" */ '../pages/Roles/ProtectedListPage');
  ...
  {
    async Component() {
      const component = await import(/* webpackChunkName: "admin-edit-roles-page" */ '../pages/Roles/CreatePage');
  ...
  {
    async Component() {
      const component = await import(/* webpackChunkName: "admin-users" */ '../pages/Users/ProtectedListPage');
  ...
  {
    async Component() {
      const component = await import(/* webpackChunkName: "admin-edit-users" */ '../pages/Users/ProtectedEditPage');
  ...
  {
    async Component() {
      const component = await import(/* webpackChunkName: "webhook-edit-page" */ '../pages/Webhooks/ProtectedEditView');
  ...
  {
    async Component() {
      const component = await import(/* webpackChunkName: "webhook-list-page" */ '../pages/Webhooks/ProtectedListView');
