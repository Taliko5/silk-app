    ...
    >
      ...
      >
        ...
        <TabPanels style={{ position: 'relative' }}>
          <TabPanel>
            <ContentTypes layout={layouts.collectionTypes} kind="collectionTypes" isFormDisabled={isFormDisabled} />
          </TabPanel>
          <TabPanel>
            <ContentTypes layout={layouts.singleTypes} kind="singleTypes" isFormDisabled={isFormDisabled} />
          </TabPanel>
          <TabPanel>
            <PluginsAndSettings layout={layouts.plugins} kind="plugins" isFormDisabled={isFormDisabled} />
          </TabPanel>
          <TabPanel>
            <PluginsAndSettings layout={layouts.settings} kind="settings" isFormDisabled={isFormDisabled} />
          </TabPanel>
        </TabPanels>
      </TabGroup>
    </PermissionsDataManagerProvider>
