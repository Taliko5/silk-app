        ...
        <form onSubmit={handleSubmit}>
          ...
          <ContentLayout>
            <Flex direction="column" alignItems="stretch" gap={6}>
                ...
                <Grid gap={5} as="dl">
                  ...
                  <GridItem col={6} s={12}>
                    ...
                    <Flex gap={3} direction="column" alignItems="start" as="dd">
                      ...
                      <Link href="https://strapi.io/pricing-self-hosted" isExternal endIcon={<ExternalLink />}>
                        {formatMessage({
              ...
              {canRead && data && (
                <CustomizationInfos canUpdate={canUpdate} ref={inputsRef} projectSettingsStored={data} />
              )}
            </Flex>
          </ContentLayout>
        </form>
